...
/* harmony import */ var _modal_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modal.page.html?ngResource */ 12057);
/* harmony import */ var _modal_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modal.page.scss?ngResource */ 29963);
...
let ModalPage = class ModalPage {
  constructor(personaService, modalCtrl, toastCtrl) {
  ...
  updatePersona() {
    ...
    return (0,C_Users_BanG_Desktop_Registro_master_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this.personaService.updatePersona(_this.persona);

      _this.modalCtrl.dismiss();

      _this.toastPresent('Alumno actualizado');
    })();
  }
  ...
  deletePersona() {
    ...
    return (0,C_Users_BanG_Desktop_Registro_master_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this2.personaService.deletePersona(_this2.persona);

      _this2.modalCtrl.dismiss();

      _this2.toastPresent('Alumno  eliminado');
    })();
  }
...
ModalPage = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Component)({
  selector: 'app-modal',
...
let PersonaService = class PersonaService {
    ...
    getPersonas() {
        const personasRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.collection)(this.firestore, 'usuarios');
        return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.collectionData)(personasRef, { idField: 'id' });
    }
    getPersonaById(id) {
        const personaRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.doc)(this.firestore, `usuarios/${id}`);
        return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.docData)(personaRef, { idField: 'id' });
    }
    addPersona(persona) {
        const personaRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.collection)(this.firestore, 'usuarios');
        return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.addDoc)(personaRef, persona);
    }
    updatePersona(persona) {
        const personaRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.doc)(this.firestore, `usuarios/${persona.id}`);
        return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.updateDoc)(personaRef, {
            name: persona.name,
    ...
    deletePersona(persona) {
        const personaRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.doc)(this.firestore, `usuarios/${persona.id}`);
        return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.deleteDoc)(personaRef);
    }
};
PersonaService.ctorParameters = () => [
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.Firestore }
];
PersonaService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,C_Users_BanG_Desktop_Registro_master_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,C_Users_BanG_Desktop_Registro_master_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,C_Users_BanG_Desktop_Registro_master_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title color=\"secondary\">Detalles</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <div *ngIf=\"persona\">\n    <ion-item>\n      <ion-label position=\"stacked\">Nombre</ion-label>\n      <ion-input type=\"text\" [(ngModel)]=\"persona.name\"></ion-input>\n    </ion-item>\n    <ion-item>\n      <ion-label position=\"stacked\">Apellido</ion-label>\n      <ion-input type=\"text\" [(ngModel)]=\"persona.lastname\"></ion-input>\n    </ion-item>\n    <ion-item>\n      <ion-label position=\"stacked\">Género</ion-label>\n      <ion-input type=\"text\" [(ngModel)]=\"persona.gender\"></ion-input>\n    </ion-item>\n    <ion-item>\n      <ion-label position=\"stacked\">Edad</ion-label>\n      <ion-input type=\"number\" [(ngModel)]=\"persona.age\"></ion-input>\n    </ion-item>\n    <ion-item>\n      <ion-label position=\"stacked\">Email</ion-label>\n      <ion-input type=\"email\" [(ngModel)]=\"persona.email\"></ion-input>\n    </ion-item> \n    <ion-item>\n      <ion-label position=\"stacked\">Imagen</ion-label>\n      <ion-input type=\"url\" [(ngModel)]=\"persona.image\"></ion-input>\n    </ion-item>\n  </div>\n  <ion-button expand=\"block\" color=\"success\" (click)=\"updatePersona()\">\n    <ion-icon name=\"save\" slot=\"start\">Actualizar</ion-icon>\n  </ion-button>\n  <ion-button expand=\"block\" color=\"danger\" (click)=\"deletePersona()\" >\n    <ion-icon name=\"trash\" slot=\"start\">Eliminar</ion-icon>\n  </ion-button>\n</ion-content>  \n";
