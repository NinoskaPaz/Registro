...
/* harmony import */ var _inicio_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./inicio.page */ 18476);
...
/* harmony import */ var _inicio_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./inicio-routing.module */ 19681);
/* harmony import */ var _inicio_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./inicio.page */ 18476);
...
/* harmony import */ var _inicio_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./inicio.page.html?ngResource */ 4588);
/* harmony import */ var _inicio_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./inicio.page.scss?ngResource */ 31075);
...
const latitude = _angular_core__WEBPACK_IMPORTED_MODULE_6__.Component;
const API_URL = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__.environment.API_URL;
const API_KEY = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__.environment.API_KEY;
let InicioPage = class InicioPage {
  constructor(toastController, httpClient, geolocation) {
    this.toastController = toastController;
    this.httpClient = httpClient;
    this.geolocation = geolocation;
    this.todayDate = new Date();
    this.getGeolocation();
    moment__WEBPACK_IMPORTED_MODULE_3__.locale('es-cl');
  ...
  cargarEntradas() {
    var fecha = moment__WEBPACK_IMPORTED_MODULE_3__(this.fecha).format('DD-MM-YY');
  ...
  inicializarNuevaEntrada() {
    var fecha = moment__WEBPACK_IMPORTED_MODULE_3__(this.fecha).format('DD-MM-YY');
    var dia = moment__WEBPACK_IMPORTED_MODULE_3__(this.fecha).format('DD');
    var mes = moment__WEBPACK_IMPORTED_MODULE_3__(this.fecha).format('MM');
    var year = moment__WEBPACK_IMPORTED_MODULE_3__(this.fecha).format('YYYY');
    this.entradaActual = {
  ...
  guardar(entradaActual) {
    ...
    return (0,C_Users_BanG_Desktop_Registro_master_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      var fecha = moment__WEBPACK_IMPORTED_MODULE_3__(_this.fecha).format('DD-MM-YYYY');

      if (_this.entradas) {
        var item = _this.entradas.find(elemento => {
          return elemento.fecha == fecha;
        });

        if (item) {
          localStorage.setItem('entradas', JSON.stringify(_this.entradas));
        } else {
          _this.guardarItem(entradaActual);
        }
      } else {
        _this.entradas = [];
...
InicioPage = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
  selector: 'app-inicio',
  template: _inicio_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__,
  styles: [_inicio_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__]
})], InicioPage);
...
"use strict";
module.exports = "ion-card {\n  height: 95%;\n}\n\nion-textarea {\n  font-size: 18px;\n}\n\n#fechaTexto {\n  font-size: 20px;\n  font-weight: bold;\n}\n\n.img-logo {\n  width: 4em;\n  position: absolute;\n  top: 0.3em;\n  right: 1em;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
